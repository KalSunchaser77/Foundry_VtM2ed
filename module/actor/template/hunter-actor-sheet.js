...
export default class HunterActorSheet extends MortalActorSheet {
	...
	async getData() {
		...
		if (data.actor.type == CONFIG.worldofdarkness.sheettype.hunter) {
			console.log(`${data.actor.name} - (${CONFIG.worldofdarkness.sheettype.hunter})`);
